...
Checking if 32-bit or 64-bit version
...
If Software is not properly installed, removing it and updating the system
...
Setting up old proxy and removing temporary files
